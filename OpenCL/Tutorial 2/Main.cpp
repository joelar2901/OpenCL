...
int main(int argc, char **argv) {
	...
	try {
		...
		cl::Event prof_event_Image_Time;
		queue.enqueueWriteBuffer(dev_image_input, CL_TRUE, 0, image_input.size(), &image_input.data()[0], NULL, &prof_event_Image_Time);

		std::cout << "Image Transfer Time: " << GetFullProfilingInfo(prof_event_Image_Time, ProfilingResolution::PROF_US) << endl;
		...
		std::cout << "Total time: [US]" <<
			(prof_event_Image_Time.getProfilingInfo<CL_PROFILING_COMMAND_END>() -
				prof_event_Image_Time.getProfilingInfo<CL_PROFILING_COMMAND_QUEUED>()) +
			(prof_event.getProfilingInfo<CL_PROFILING_COMMAND_END>() - prof_event.getProfilingInfo<CL_PROFILING_COMMAND_QUEUED>()) +
			(prof_CH.getProfilingInfo<CL_PROFILING_COMMAND_END>() - prof_CH.getProfilingInfo<CL_PROFILING_COMMAND_QUEUED>()) +
			(prof_event3.getProfilingInfo<CL_PROFILING_COMMAND_END>() - prof_event3.getProfilingInfo<CL_PROFILING_COMMAND_QUEUED>()) +
			(prof_event4.getProfilingInfo<CL_PROFILING_COMMAND_END>() - prof_event4.getProfilingInfo<CL_PROFILING_COMMAND_QUEUED>()) <<
			std::endl;
